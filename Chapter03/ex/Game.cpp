...
Game::Game() : mWindow(nullptr), mRenderer(nullptr), mIsRunning(true), mUpdatingActors(false), mResurrectionCoolDown(0.f) {}
...
void Game::UpdateGame() {
	...
	mResurrectionCoolDown -= deltaTime;
	if (mResurrectionCoolDown <= 0 && mShip == nullptr) {
		mShip = new Ship(this);
