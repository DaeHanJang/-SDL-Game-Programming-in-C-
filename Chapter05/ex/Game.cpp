...
Game::Game()
	...
	mBackgroundColor(Color::Black), mInterpolationCoefficient(0.f) {}
...
void Game::UpdateGame() {
	...
	mInterpolationCoefficient += deltaTime;
	//Black
	if (mInterpolationCoefficient >= 0.f && mInterpolationCoefficient < 1.f) {
		mBackgroundColor = Vector3::Lerp(Color::Black, Color::Blue, mInterpolationCoefficient);
	}
	//Blue
	else if (mInterpolationCoefficient >= 1.f && mInterpolationCoefficient < 2.f)
		mBackgroundColor = Vector3::Lerp(Color::Blue, Color::Red, mInterpolationCoefficient - 1.f);
	//Red
	else if (mInterpolationCoefficient >= 2.f && mInterpolationCoefficient < 3.f)
		mBackgroundColor = Vector3::Lerp(Color::Red, Color::Black, mInterpolationCoefficient - 2.f);
	else mInterpolationCoefficient = 0.f;
}

void Game::GenerateOutput() {
	
	//glClearColor(0.86f, 0.86f, 0.86f, 1.f); //색상을 회색으로 설정
	glClearColor(mBackgroundColor.x, mBackgroundColor.y, mBackgroundColor.z, 1.f);
...
void Game::CreateSpriteVerts() {
	float vertices[] = {
		-0.5f,  0.5f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, //왼쪽 상단
		 0.5f,  0.5f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, //오른쪽 상단
		 0.5f, -0.5f, 0.f, 1.f, 1.f, 0.f, 0.f, 1.f, //오른쪽 하단
		-0.5f, -0.5f, 0.f, 0.f, 1.f, 1.f, 0.f, 0.f //왼쪽 하단
	};
